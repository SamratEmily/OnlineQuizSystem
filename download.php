        ...
        <table class="table table-hover table-bordered">
            ...
            <tbody>
                ...
                while ($row = $res->fetch_object()) {
                    ...
                    if ($cnt == 3 || $cnt == 4) {
                        if ($cnt == 3) {
                            $totalclass = $row->marks;
                            $totalmarks = 0;
                        } else {
                            $totalmarks = (($row->marks) / $totalclass) * 5;
                ...
                <tr>
                    ...
                    <td><b><?php echo htmlentities($totlcount); ?></b> out of <b><?php echo htmlentities($outof = 40); ?></b></td>
                </tr>
                <tr>
                    <th scope="row" colspan="2">Percntage</th>
                    <td><b><?php echo  htmlentities($totlcount * (100) / 40); ?> %</b></td>
                </tr>
